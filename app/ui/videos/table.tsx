import { UpdateVideo, DeleteVideo } from '@/app/ui/videos/buttons';
              ...
              >
                ...
                <div className="flex w-full items-center justify-between pt-4">
                  ...
                  <div className="flex justify-end gap-2">
                    <UpdateVideo id={video.videos_id} />
                    <DeleteVideo id={video.videos_id} />
                  </div>
                </div>
              </div>
            ))}
